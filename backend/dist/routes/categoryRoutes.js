...
import { categoryCreateSchema, categoryUpdateSchema, categoryIdParamSchema } from '../validation/category.validation.js';
import { createCategory, getCategoryById, getAllCategories, updateCategory, deleteCategory } from '../controllers/categoryController.js';
const router = Router();
// Create
